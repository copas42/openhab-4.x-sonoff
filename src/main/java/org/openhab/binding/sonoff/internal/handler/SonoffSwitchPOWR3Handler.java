...
/**
 * The {@link SonoffSwitchPOWR3Handler} allows the handling of commands and updates to Devices with uuid 32
 *
 * @author David Murton - Initial contribution
 */
@NonNullByDefault
public class SonoffSwitchPOWR3Handler extends SonoffBaseDeviceHandler {

    private final Logger logger = LoggerFactory.getLogger(SonoffSwitchPOWR3Handler.class);
    private @Nullable ScheduledFuture<?> localTask;
    private @Nullable ScheduledFuture<?> consumptionTask;

    public SonoffSwitchPOWR3Handler(Thing thing) {
        super(thing);
    }
